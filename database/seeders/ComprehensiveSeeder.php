...
class ComprehensiveSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $r1 = Recruiter::firstOrCreate(['user_id' => $r1User->id], [
            ...
            'tier'                => 'elite',
            'trust_level'         => 'trusted',
            'industries'          => json_encode(['Financial Services', 'Fintech', 'Banking']),
            'seniority_focus'     => json_encode(['c_suite', 'vp_director']),
            'geographies'         => json_encode(['Singapore', 'Indonesia', 'Vietnam']),
        ...
        $r2 = Recruiter::firstOrCreate(['user_id' => $r2User->id], [
            ...
            'industries'          => json_encode(['Technology', 'E-commerce', 'SaaS']),
            'seniority_focus'     => json_encode(['vp_director', 'manager']),
            'geographies'         => json_encode(['Singapore', 'Malaysia', 'Thailand']),
        ...
        $r3 = Recruiter::firstOrCreate(['user_id' => $r3User->id], [
            ...
            'tier'                => 'junior',
            'trust_level'         => 'standard',
            'industries'          => json_encode(['FMCG', 'Retail', 'Consumer Goods']),
            'seniority_focus'     => json_encode(['vp_director', 'manager']),
            'geographies'         => json_encode(['Vietnam', 'Cambodia', 'Laos']),
        ...
        $mandate1 = Mandate::firstOrCreate(
            ...
            [
                ...
                'reward_max'             => 84000.00,
                'reward_pct'             => 0.15,
                'must_haves'             => json_encode(['15+ years financial risk experience', 'SEA regulatory experience', 'C-suite leadership']),
                'nice_to_haves'          => json_encode(['MAS regulated entity background', 'Bilingual Mandarin/English', 'Lending or insurance risk background']),
                'green_flags'            => json_encode(['Big-4 bank CRO or deputy CRO background', 'Previous MAS or OJK interaction', 'Led teams of 30+ people']),
                'red_flags'              => json_encode(['No SEA experience', 'Less than 10 years in risk', 'Pure consulting background with no operational role']),
        ...
        $mandate2 = Mandate::firstOrCreate(
            ...
            [
                ...
                'reward_max'             => 72000.00,
                'reward_pct'             => 0.15,
                'must_haves'             => json_encode(['12+ years engineering', '5+ years engineering leadership', 'Large-scale distributed systems']),
                'nice_to_haves'          => json_encode(['E-commerce platform experience', 'Mandarin speaking', 'FAANG or Tier-1 tech background']),
                'green_flags'            => json_encode(['Led 100+ engineer org', 'Built marketplace or payments systems', 'Strong OSS contributions']),
                'red_flags'              => json_encode(['No people management experience', 'Pure IC background', 'No experience at scale']),
                'screening_questions'    => json_encode([
        ...
        $mandate3 = Mandate::firstOrCreate(
            ...
            [
                ...
                'reward_max'             => 52500.00,
                'reward_pct'             => 0.15,
                'must_haves'             => json_encode(['FMCG GM or CM experience', 'SEA leadership', 'P&L ownership $500M+']),
                'nice_to_haves'          => json_encode(['Vietnamese language', 'Unilever or P&G background', 'Local Vietnam network']),
                'green_flags'            => json_encode(['Led $1B+ P&L', 'Previously in Vietnam market', 'Known in local FMCG circle']),
                'red_flags'              => json_encode(['No FMCG background', 'No P&L experience', 'Pure expat with no SEA roots']),
                'screening_questions'    => json_encode([
        ...
        $mandate4 = Mandate::firstOrCreate(
            ...
            [
                ...
                'reward_max'             => 60000.00,
                'reward_pct'             => 0.15,
                'must_haves'             => json_encode(['Product leadership in fintech', '8+ years product management', 'SEA market experience']),
                'nice_to_haves'          => json_encode(['Payments or lending product experience', 'Multi-market product roles']),
                'green_flags'            => json_encode(['VP Product at a major neobank', 'Launched financial product at scale']),
                'red_flags'              => json_encode(['No fintech experience', 'Less than 5 years PM experience']),
                'screening_questions'    => json_encode([
        ...
        $cand1 = Candidate::firstOrCreate(
            ...
            [
                ...
                'skills'          => json_encode(['Enterprise Risk', 'Credit Risk', 'Regulatory Compliance', 'Team Leadership', 'MAS Engagement', 'Basel III', 'Stress Testing']),
        ...
        $cand2 = Candidate::firstOrCreate(
            ...
            [
                ...
                'skills'          => json_encode(['Operational Risk', 'Regulatory Risk', 'Insurance Risk', 'APAC Leadership', 'Board Presentations']),
        ...
        $cand3 = Candidate::firstOrCreate(
            ...
            [
                ...
                'salary_currency' => 'SGD',
                'nationality'     => 'Singaporean',
                'skills'          => json_encode(['Distributed Systems', 'Microservices', 'Team Leadership', 'E-commerce Infrastructure', 'Golang', 'Kubernetes', 'AWS']),
        ...
        $cand4 = Candidate::firstOrCreate(
            ...
            [
                ...
                'skills'          => json_encode(['P&L Management', 'FMCG Sales', 'GTM Strategy', 'Distributor Management', 'Government Relations', 'Vietnamese Market Expertise']),
        ...
        $cand5 = Candidate::firstOrCreate(
            ...
            [
                ...
                'salary_currency' => 'SGD',
                'nationality'     => 'Singaporean',
                'skills'          => json_encode(['P&L Management', 'FMCG', 'Consumer Insights', 'Board Reporting', 'Regional Leadership']),
        ...
        $sub1 = CddSubmission::firstOrCreate(
            ...
            [
                ...
                'submission_number'   => 1,
                'ai_score'            => 92,
                'score_breakdown'     => json_encode(['experience' => 95, 'industry' => 90, 'scope' => 92, 'leadership' => 93, 'digital' => 88]),
                ...
                'green_flags'         => json_encode(['Current DBS CRO > direct comparable', '18 years experience > threshold', 'Active MAS engagement history']),
                'red_flags'           => json_encode(['3-month notice period', 'Banking vs. pure fintech background (minor gap)']),
        ...
        $sub2 = CddSubmission::firstOrCreate(
            ...
            [
                ...
                'submission_number'   => 2,
                'ai_score'            => 79,
                'score_breakdown'     => json_encode(['experience' => 82, 'industry' => 70, 'scope' => 83, 'leadership' => 88, 'digital' => 71]),
                ...
                'green_flags'         => json_encode(['Global Head title', 'Board-level presenter', 'MAS relationship', 'Was Group CRO shortlist candidate']),
                'red_flags'           => json_encode(['Insurance-first, not lending/credit', 'Gap in credit risk depth']),
        ...
        $sub3 = CddSubmission::firstOrCreate(
            ...
            [
                ...
                'submission_number'   => 1,
                'ai_score'            => 96,
                'score_breakdown'     => json_encode(['experience' => 97, 'industry' => 95, 'scope' => 96, 'leadership' => 95, 'digital' => 98]),
                ...
                'green_flags'         => json_encode(['120-person team at direct competitor', 'Previous Grab experience', '50M txn/day scale', 'Google background']),
                'red_flags'           => json_encode(['6-week notice may delay start']),
        ...
        $sub4 = CddSubmission::firstOrCreate(
            ...
            [
                ...
                'submission_number'   => 1,
                'ai_score'            => 91,
                'score_breakdown'     => json_encode(['experience' => 93, 'industry' => 95, 'scope' => 90, 'leadership' => 94, 'digital' => 82]),
                ...
                'green_flags'         => json_encode(['$650M P&L direct comparable', 'Native Vietnamese', 'Nestlé brand > MNC credibility', 'Government relations depth']),
                'red_flags'           => json_encode(['Nestlé vs. Unilever category differences (minor)', 'Currently happy — needs compelling package']),
                'admin_review_status' => 'approved',
                'admin_reviewed_by'   => $admin->id,
        ...
        $mandateFilled = Mandate::firstOrCreate(
            ...
            [
                ...
                'reward_max'             => 42000.00,
                'reward_pct'             => 0.15,
                'must_haves'             => json_encode(['Finance leadership in fintech', 'SEA exposure']),
                'nice_to_haves'          => json_encode(['CPA/CA qualified', 'Payment industry background']),
                'green_flags'            => json_encode(['VP Finance at fintech', 'Managed large team']),
                'red_flags'              => json_encode(['No fintech experience']),
                'screening_questions'    => json_encode([]),
                'status'                 => 'filled',
                'is_exclusive'           => false,
                'is_featured'            => false,
        ...
        $subHired = CddSubmission::firstOrCreate(
            ...
            [
                ...
                'submission_number'        => 1,
                'ai_score'                 => 88,
                'score_breakdown'          => json_encode(['experience' => 90, 'industry' => 85, 'scope' => 88, 'leadership' => 90, 'digital' => 86]),
                ...
                'green_flags'              => json_encode(['Strong P&L background', 'Regional scope', 'Excellent commercial acumen']),
                'red_flags'               => json_encode([]),
                'admin_review_status'      => 'approved',
                'admin_reviewed_by'        => $admin->id,
