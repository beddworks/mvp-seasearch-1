        ...
        return Inertia::render('Admin/Dashboard', [
            'stats' => [
                ...
                'unclaimed_24h'       => Mandate::active()->unclaimed()
                                            ...
                                            ->count(),
                'placements_mtd'      => Placement::whereMonth('placed_at', $now->month)->whereYear('placed_at', $now->year)->count(),
                'revenue_mtd'         => Placement::whereMonth('placed_at', $now->month)->whereYear('placed_at', $now->year)->sum('platform_fee') ?? 0,
                'placements_ytd'      => Placement::whereYear('placed_at', $now->year)->count(),
                'revenue_ytd'         => Placement::whereYear('placed_at', $now->year)->sum('platform_fee') ?? 0,
            ],
            ...
            'recentActivity'  => AppNotification::whereHas('user', fn($q) =>
